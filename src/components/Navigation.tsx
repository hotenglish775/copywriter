...
const Navigation = () => {
  ...
  return (
    <nav className="relative z-50 bg-navy-950/95 backdrop-blur-cyber border-b border-teal-500/20 shadow-glow">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile Navigation */}
        {isOpen && (
          <div className="md:hidden bg-navy-950/98 backdrop-blur-cyber border-t border-teal-500/20 rounded-b-2xl shadow-glow-lg">
