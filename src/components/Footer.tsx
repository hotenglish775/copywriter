      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div className="flex space-x-4">
              {[
                ...
                <a
                  key={index}
                  href={social.href}
                  className="text-slate-400 hover:text-teal-400 transition-colors p-2 rounded-lg hover:bg-navy-800"
                >
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.name}>
                  <Link
                    to={link.path}
                    className="text-slate-300 hover:text-teal-400 text-sm transition-colors font-sans hover:translate-x-1 transform duration-300 inline-block"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <Link
              to="/booking"
              className="bg-gradient-primary text-white px-6 py-3 rounded-full text-sm font-medium hover:bg-gradient-primary-hover hover:shadow-glow transition-all duration-300 transform hover:scale-105 inline-block font-sans"
            >
              Start Your Project
            </Link>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-navy-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link to="#" className="text-slate-400 hover:text-teal-400 text-sm transition-colors font-sans">
                Privacy Policy
              </Link>
              <Link to="#" className="text-slate-400 hover:text-teal-400 text-sm transition-colors font-sans">
                Terms of Service
